...
export const DONATION_CARDS_DATA = [
    ...
    {
        title: "Toys",
        text: "We want some stuffed toys for the kids",
        age: "3-7",
        gender: "Unisex",
        type: "Stuffed Toys",
   ...
   
    {
        ...
        text: "We need 3 X-Ray machines for our hospital",
    ...
    },
    {
        ...
        text: "We need various types of fruits and vegetables for children",
        quantity: "20 kg",
        progress: 65,
    ...
    },
    {
        ...
        text: "We want some syringes and masks",
    ...
    {
        title: "Type A or Type O Blood",
        text: "Patient is in urgent need for 2 bags of blood Type C",
    ...
    {
        title: "Arabic School book",
        text: "We want Arabic selah el telmeez to help 6th grade students",
        bookName: 'Selah el Telmeez',
        author: 'Mr. Hamdy Mostafa',
        language: 'Arabic',
        edition: '2024',
        summary: 'An educational book that helps 6th graders understand their arabic lanuage better',
        progress: 30,
    ...
    {
        title: "Cars",
        text: "We want to give the kids car toys",
        age: "3-10",
        gender: "Boys",
        type: "Cars",
    ...
    },
    {
        ...
        text: "We are looking for 200 pencils for kids in our orphanage",
        quantity: 200,
   ...
   
    {
        ...
        text: "Our patient needs statin urgently",
    ...
    {
        title: "Type O Blood",
        text: "Patient is in urgent need for 4 bags of blood Type O",
    ...
    {
        title: "Baked Goods",
        text: "We need various types of baked goods for our staff and kids at the mosque",
        quantity: "60",
        progress: 10,
