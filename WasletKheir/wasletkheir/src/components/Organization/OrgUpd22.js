...
export default function OrgUpd22() {
    ...
    const [donations, setDonations] = useState([
        { image: 'https://i.ibb.co/PwnmDGv/school-jackets.jpg', title: 'Winter Jackets For School', description: 'We would appreciate receiving winter jackets for our students to wear.', progress: 15 },
        { image: 'https://www.buildabear.co.uk/dw/image/v2/BBNG_PRD/on/demandware.static/-/Sites-buildabear-master/default/dwa49d338d/29231221227229x20237010.jpg?sw=800&sh=800&sm=fit', title: 'Plushies', description: 'We would like to have plushies for our younger students for their comfort.', progress: 25 },
